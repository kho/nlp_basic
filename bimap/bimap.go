...
// if it is not.
func (m *Map) FindByInt(i int32) string {
...
func (m *Map) AppendByString(strs []string, ints *[]int32) {
	for _, s := range strs {
...
func (m *Map) TranslateByString(strs []string) []int32 {
...
// strings.
func (m *Map) TranslateByInt(ints []int32) []string {
